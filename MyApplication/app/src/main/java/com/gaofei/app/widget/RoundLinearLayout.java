...
public class RoundLinearLayout extends LinearLayout {
    ...
    public RoundLinearLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (attrs != null) {
            final TypedArray a = getContext().obtainStyledAttributes(attrs, R.styleable.RoundFrameLayout, defStyleAttr, 0);
            float radius = a.getDimension(R.styleable.RoundLinearLayout_radius, 0);
            topLeftRadius = a.getDimension(R.styleable.RoundLinearLayout_topLeftRadius, radius);
            topRightRadius = a.getDimension(R.styleable.RoundLinearLayout_topRightRadius, radius);
            bottomLeftRadius = a.getDimension(R.styleable.RoundLinearLayout_bottomLeftRadius, radius);
            bottomRightRadius = a.getDimension(R.styleable.RoundLinearLayout_bottomRightRadius, radius);
            a.recycle();
        }
