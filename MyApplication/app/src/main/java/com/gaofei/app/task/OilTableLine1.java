...
public class OilTableLine1 extends View {
    ...
    public OilTableLine1(Context context, AttributeSet attrs) {
        super(context, attrs);
        mPaint = new Paint();
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mPath.reset();
        //在油表路径中增加一个从起始弧度
        mPath.addArc(mTableRectF, 60, 360);
        //计算路径的长度
